...
export const metadata: Metadata = {
  title: "Floor Plans Delivered | Mount Vernon Lofts — Montrose Condos",
  description: "Your floor plans have been sent to your email. Thank you for your interest in Mount Vernon Lofts, modern condos in Montrose, Houston.",
  robots: "noindex, nofollow"
}

export default function ThankYouFloorPlansPage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-mvl-warm-white to-white">
      <DataLayerEvent event="floor_plans_conversion" data={{ conversion_type: 'floor_plans_request' }} />
              ...
              <StaggerItem>
                <div className="mb-8">
                  ...
                  <p className="text-mvl-espresso text-xl md:text-2xl font-light">
                    Your floor plans are on their way to your inbox
                  </p>
                </div>
              </StaggerItem>
              ...
              <StaggerItem>
                <div className="bg-white rounded-lg shadow-lg p-8 mb-12 max-w-2xl mx-auto">
                  ...
                  <p className="text-mvl-espresso/80 mb-6">
                    Your detailed floor plans have been sent to your email address.
                    The PDF includes unit layouts and complete specifications.
                  </p>
              ...
              <StaggerItem>
                <div className="bg-mvl-espresso text-white rounded-lg p-8 mb-12">
                  ...
                  <p className="text-mvl-beige text-lg mb-8 max-w-2xl mx-auto">
                    Now that you have the floor plans, let our team help you discover
                    which unit works best for you.
                  </p>
                  ...
                  <div className="grid md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-sm text-mvl-beige/80">
                        Receive pricing, finishes, and availability details
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    >
                      <a href={`mailto:${CONTACT_CONFIG.email}?subject=Schedule a Tour - Floor Plans Follow-up`}>
