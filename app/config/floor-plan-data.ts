...
export const units: ReadonlyArray<Unit> = [
  ...
  { unitNumber: '1-9', floorPlan: '1bed-a3', floor: 2, side: 'East', sqft: 778, status: 'occupied' },
  ...
  { unitNumber: '1-39', floorPlan: 'studio-s1', floor: 3, side: 'East', sqft: 612, status: 'occupied' },
