...
const securityHeaders = [
  ...
  },
  {
    ...
    value: `
      ...
      frame-src 'self' https://www.googletagmanager.com https://www.google.com https://*.google.com https://maps.google.com https://vercel.live https://*.tawk.to https://my.matterport.com;
    `.replace(/\s{2,}/g, ' ').trim()
  }
];
